            ...
            <div class="container-xxxl">
                <div class="header-wrapper">
                    ...
                    <div class="header-items header__center">
                        @if (is_plugin_active('ecommerce'))
                            <form class="form--quick-search" data-ajax-url="{{ route('public.ajax.search-products') }}"
                                action="{{ route('public.products') }}" method="get">
                                <div class="form-group--icon" style="display: none">
                                    ...
                                    <select class="form-control product-category-select" id="product-category-select"
                                        name="categories[]">
                            ...
                            @if (EcommerceHelper::isCompareEnabled())
                                <div class="header__extra header-compare">
                                    <a class="btn-compare" href="{{ route('public.compare') }}">
                                        ...
                                        <i class="fa-duotone fa-arrows-repeat tx-yellow"></i>
                                        <span
                            ...
                            @if (EcommerceHelper::isWishlistEnabled())
                                <div class="header__extra header-wishlist">
                                    <a class="btn-wishlist" href="{{ route('public.wishlist') }}">
                                        ...
                                        <i class="fa-duotone fa-heart tx-yellow"></i>
                                ...
                                <div class="header__extra cart--mini" role="button" tabindex="0">
                                    <div class="header__extra">
                                        <a class="btn-shopping-cart" href="{{ route('public.cart') }}">
                                            ...
                                            {{-- <i class="fa-duotone fa-cart-shopping tx-yellow"></i> --}}
                                            <i class="fa-duotone fa-cart-shopping-fast tx-yellow"></i>
                                            <span
        ...
        <div @class([
            ...
            <div class="header-wrapper">
                <nav class="navigation">
                    <div class="container-xxxl align-items-center">
